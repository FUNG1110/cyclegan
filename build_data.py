...
tf.flags.DEFINE_string('X_input_dir', 'data/city2nl/traincity',
                       'X input directory, default: data/city2nl/traincity')
tf.flags.DEFINE_string('Y_input_dir', 'data/city2nl/trainnl',
                       'Y input directory, default: data/city2nl/trainnl')
tf.flags.DEFINE_string('X_output_file', 'data/tfrecords/city.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/city.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'data/tfrecords/nl.tfrecords',
                       'Y output tfrecords file, default: data/tfrecords/nl.tfrecords')
