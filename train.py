...
tf.flags.DEFINE_string('X', 'data/tfrecords/city.tfrecords',
                       'X tfrecords file for training, default: data/tfrecords/city.tfrecords')
tf.flags.DEFINE_string('Y', 'data/tfrecords/nl.tfrecords',
                       'Y tfrecords file for training, default: data/tfrecords/nl.tfrecords')
